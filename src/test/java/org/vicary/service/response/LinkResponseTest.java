...
class LinkResponseTest {
    ...
    @Test
    void sendFile_expectEquals_YouTubeFileRequestAndDownloaderAndService() throws Exception {
        //given
...
//        verify(terminalExecutor).removeFile(fileResponse.getDownloadedFile().getFile());
//        verify(terminalExecutor).removeFile(fileResponse.getThumbnail().getFile());
