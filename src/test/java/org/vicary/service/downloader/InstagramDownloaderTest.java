...
class InstagramDownloaderTest {
    ...
    void downloadFile_expectEquals_NormalFileResponse() throws IOException {
        ...
        when(commands.downloadInstagram(givenFilePath, givenFileResponse)).thenReturn(givenCommand);
    ...
    void getFileInfo_expectEquals_ValidRequest() throws IOException {
        ...
        String givenServiceName = "instagram";
        ...
        FileResponse expectedFileResponse = FileResponse.builder()
                ...
                .build();
        //when
        when(commands.fileInfoInstagram(givenURL)).thenReturn(givenCommands);
        ...
        //then
        assertEquals(expectedFileResponse, actualFileResponse);
        verify(commands).fileInfoInstagram(givenURL);
    ...
    void getFileFromRepository_expectEquals_ValidFileResponse() {
        ...
        FileResponse expectedFileResponse = FileResponse.builder()
                ...
                .build();
        //when
        when(fileService.findByInstagramIdAndExtensionAndQuality(givenId, givenExtension, givenQuality)).thenReturn(Optional.ofNullable(fileEntity));
        ...
        //then
        assertEquals(expectedFileResponse, actualFileResponse);
        verify(fileService).findByInstagramIdAndExtensionAndQuality(givenId, givenExtension, givenQuality);
